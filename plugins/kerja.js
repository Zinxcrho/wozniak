...
let time = global.db.data.users[m.sender].lastjb + 3000000
...
//PEMBATAS
let penumpan = ['mas mas','bapak bapak','cewe sma','bocil epep','emak emak','mantan mu','wibu','mba kunti','mas pocong','fans kpop','pak haji',]
