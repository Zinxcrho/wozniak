...
let handler = async (m, { conn, usedPrefix, owner }) => { 
   ...
   ///// else conn.berbu[m.chat] = true
          ...
          let sapi = `${Math.floor(Math.random() * 100)}`.trim() 
        let babi = `${Math.floor(Math.random() * 105)}`.trim() 
        let ayam = `${Math.floor(Math.random() * 205)}`.trim() 
        let banteng = `${Math.floor(Math.random() * 300)}`.trim() 
        let unta = `${Math.floor(Math.random() * 309)}`.trim() 
        let keledai = `${Math.floor(Math.random() * 244)}`.trim() 
        let domba = `${Math.floor(Math.random() * 260)}`.trim() 
        let kambing = `${Math.floor(Math.random() * 250)}`.trim() 
